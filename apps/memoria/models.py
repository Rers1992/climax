...
class MemIndicesextremosclimaticos(models.Model):
    ...
    cdd = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    csdi = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    cwd = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    dtr = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    fd0 = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    gsl = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    gsl2 = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    id0 = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    prcptot = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    r10mm = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    r20mm = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    r95p = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    r99p = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    r50mm = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    rx1day = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    rx5day = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    sdii = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    su25 = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    tn10p = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    tn90p = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    tnn = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    txn = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    tr20 = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    tx10p = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    tx90p = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    tnx = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    txx = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    wsdi = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    temmax = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    temmin = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    premax = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
...
class MemEstadisticas(models.Model):
    ...
    cuartil2max = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    cuartil2min = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
    cuartil2pre = models.DecimalField(max_digits=1000, decimal_places=1, blank=True, null=True)
