...
class MemIndicesextremosclimaticos(models.Model):
    ...
    cdd = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    csdi = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    cwd = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    dtr = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    fd0 = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    gsl = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    gsl2 = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    id0 = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    prcptot = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    r10mm = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    r20mm = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    r95p = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    r99p = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    r50mm = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    rx1day = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    rx5day = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    sdii = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    su25 = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    tn10p = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    tn90p = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    tnn = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    txn = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    tr20 = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    tx10p = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    tx90p = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    tnx = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    txx = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
    wsdi = models.DecimalField(max_digits=1000, blank=True, null=True, decimal_places=1)
