  ...
  cargarListaEstaciones(data){
      return <div className="row">
          {data.map((dato) => (
              ...
              <div className="card card-photo contenedor" onClick={() => this.setState({ codigoEstacion: dato.codigo })}>
          ...
          <div  className="card-body">
            ...
            <div className="row col-12 col-12 col-md-12 col-lg-12 col-xl-12 pb-4">
                <div className="col-3 col-md-3 col-lg-3 col-xl-3">
                    <button className="btn btn-info">Bitacora</button>
                </div>
                <div className="col-6 col-md-6 col-lg-6 col-xl-6">
                    <button className="btn btn-success">Más Detalles</button>
                </div>
            </div>
          </div>
        </div>
